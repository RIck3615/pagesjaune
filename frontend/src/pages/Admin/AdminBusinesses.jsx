...
const AdminBusinesses = () => {
  ...
  const toggleActiveMutation = useMutation(
    ({ businessId, isActive }) => adminService.updateBusiness(businessId, { is_active: isActive }),
    {
      onSuccess: () => {
        toast.success('Statut actif modifié');
        queryClient.invalidateQueries(['admin-businesses']);
      },
      onError: (error) => {
        toast.error('Erreur lors de la modification');
  ...
  const handleToggleActive = (businessId, currentStatus) => {
    toggleActiveMutation.mutate({ businessId, isActive: !currentStatus });
  };
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center">
          ...
          <p className="mb-6 text-gray-600">Impossible de charger les entreprises</p>
          <button
      ...
      <div className="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Vérifiez et modérez les entreprises de la plateforme
          </p>
        </div>
